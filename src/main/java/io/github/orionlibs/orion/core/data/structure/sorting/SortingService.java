package io.github.orionlibs.orion.core.data.structure.sorting;

import io.github.orionlibs.orion.core.abstraction.OrionService;
import io.github.orionlibs.orion.core.data.structure.array.ArraySortService;
import io.github.orionlibs.orion.core.data.structure.sorting.tasks.ReverseSortMapByKeyTask;
import io.github.orionlibs.orion.core.data.structure.sorting.tasks.ReverseSortMapByValueTask;
import io.github.orionlibs.orion.core.data.structure.sorting.tasks.SortMapByKeyTask;
import io.github.orionlibs.orion.core.data.structure.sorting.tasks.SortMapByValueTask;
