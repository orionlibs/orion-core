...
import io.github.orionlibs.orion.core.data.structure.KeyValueDataStructure;
...
import io.github.orionlibs.orion.core.data.structure.list.type.OrionUnmodifiableArrayList;
...
import io.github.orionlibs.orion.core.data.structure.set.type.OrionUnmodifiableHashSet;
import io.github.orionlibs.orion.core.math.RandomNumberGenerationService;
import io.github.orionlibs.orion.core.stream.OrionStream;
...
public interface OrionMap<T1, T2> extends Map<T1, T2>, KeyValueDataStructure<T1, T2>
{
    ...
    @SuppressWarnings("unchecked")
    public default OrionMap<T1, T2>[] splitMapIntoSubmaps(int numberOfSubmaps, Function<OrionList<Map.Entry<T1, T2>>, OrionMap<T1, T2>> constructorOfMapImplementationToUse)
    {
    ...
    @Override
    public default OrionSet<Map.Entry<T1, T2>> getAsUnmodifiableOrionSet()
    {
