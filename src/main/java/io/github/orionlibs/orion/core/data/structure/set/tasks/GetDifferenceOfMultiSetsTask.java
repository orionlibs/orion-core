...
public class GetDifferenceOfMultiSetsTask<T> extends Orion
{
        ...
        else
        {
            ...
            for(T elementInSet1 : set1.getAsArray())
            {
                ...
                if(result.notContains(elementInSet1))
                {
                    ...
                    {
                        long multiplicityOfElement = Math.max(set1.getMultiplicityOfElement(elementInSet1) - set2.getMultiplicityOfElement(elementInSet1), 0);
            ...
            for(T elementInSet2 : set2.getAsArray())
            {
                ...
                if(result.notContains(elementInSet2))
                {
                    ...
                    {
                        long multiplicityOfElement = Math.max(set1.getMultiplicityOfElement(elementInSet2) - set2.getMultiplicityOfElement(elementInSet2), 0);
