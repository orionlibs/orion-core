package io.github.orionlibs.orion.core.data.structure.map.type;
...
import io.github.orionlibs.orion.core.data.structure.UnindexedDataStructure;
import io.github.orionlibs.orion.core.data.structure.UnorderedDataStructure;
import io.github.orionlibs.orion.core.data.structure.list.OrionList;
import io.github.orionlibs.orion.core.data.structure.map.OrionMap;
...
public class OrionConcurrentHashMap<T1, T2> extends ConcurrentHashMap<T1, T2> implements OrionMap<T1, T2>, Cloneable, UnorderedDataStructure, UnindexedDataStructure
{
    ...
    public OrionConcurrentHashMap(OrionList<Map.Entry<T1, T2>> other)
    {
