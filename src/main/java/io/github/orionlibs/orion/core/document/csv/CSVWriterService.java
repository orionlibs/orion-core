package io.github.orionlibs.orion.core.document.csv;

import com.opencsv.CSVWriter;
import io.github.orionlibs.orion.core.abstraction.OrionService;
import io.github.orionlibs.orion.core.document.csv.tasks.BuildCSVBodyTask;
import io.github.orionlibs.orion.core.document.csv.tasks.BuildCSVHeaderTask;
...
public class CSVWriterService extends OrionService
{
    ...
    {
        OrionUtils.closeResource(this.writer);
    }
