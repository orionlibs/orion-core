package io.github.orionlibs.orion.core.cryptology.encoding.xss;

import io.github.orionlibs.orion.core.abstraction.OrionService;
import io.github.orionlibs.orion.core.cryptology.encoding.xss.tasks.DecodeFromXSSTask;
import io.github.orionlibs.orion.core.cryptology.encoding.xss.tasks.EncodeWithXSSTask;
