...
import io.github.orionlibs.orion.core.cryptology.encryption.rsa.tasks.DecryptFromRSATask;
import io.github.orionlibs.orion.core.cryptology.encryption.rsa.tasks.EncryptToRSATask;
import io.github.orionlibs.orion.core.cryptology.encryption.rsa.tasks.GenerateRSAKeyTask;
...
public class RSAEncryptionService extends OrionService
{
    ...
    {
        generateRSAKey();
        String username = "efthymiou.dimitrios1@gmail.com";
