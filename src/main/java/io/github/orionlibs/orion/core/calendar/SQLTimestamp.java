...
public class SQLTimestamp extends Timestamp
{
    ...
    public String printTime()
    {
        ...
        StringBuilder sb = new StringBuilder(printTimeWithoutSeconds());
        sb.append(":");
        sb.append(FormattedSQLTimestamp.formatSecondsString(this));
        return sb.toString();
    }
    ...
    /*
     * public String toString() { return formattedDateTime; }
     */
