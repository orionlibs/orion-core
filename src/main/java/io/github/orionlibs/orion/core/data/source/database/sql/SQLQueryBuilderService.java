...
public class SQLQueryBuilderService extends OrionService
{
    ...
    public SQLQuery buildParametersArray(Object model)
    {
        ...
        {
            OrionList<Object> parametersTemp = OrionArrayList.of(columnsToCreateParametersFor.size());
            ...
            setParameters(parametersTemp.getAsArrayOfObjects());
        }
