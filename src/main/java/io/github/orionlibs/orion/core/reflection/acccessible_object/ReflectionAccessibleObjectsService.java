package io.github.orionlibs.orion.core.reflection.acccessible_object;

import io.github.orionlibs.orion.core.abstraction.OrionService;
import io.github.orionlibs.orion.core.reflection.acccessible_object.tasks.GetAllAccessibleObjectsArrayTask;
import io.github.orionlibs.orion.core.reflection.acccessible_object.tasks.GetDeclaredAccessibleObjectsArrayTask;
import io.github.orionlibs.orion.core.reflection.acccessible_object.tasks.GetInherittedAccessibleObjectsArrayTask;
import java.lang.reflect.AccessibleObject;
import java.util.Arrays;
import java.util.List;

public class ReflectionAccessibleObjectsService extends OrionService
{
