package io.github.orionlibs.orion.core.reflection.method.retrieval;

import io.github.orionlibs.orion.core.abstraction.OrionService;
import io.github.orionlibs.orion.core.exception.Assert;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.GetDeclaredDefaultMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.GetDeclaredMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.GetDeclaredProtectedMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.GetDeclaredPublicMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.GetInherittedMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.GetPrivateMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.IsDefaultMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.IsPrivateMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.IsProtectedMethodTask;
import io.github.orionlibs.orion.core.reflection.method.retrieval.tasks.IsPublicMethodTask;
import java.lang.reflect.Method;

public class ReflectionMethodRetrievalService extends OrionService
{
