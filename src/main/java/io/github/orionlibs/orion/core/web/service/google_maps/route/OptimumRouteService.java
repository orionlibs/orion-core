...
import io.github.orionlibs.orion.core.math.MathService;
import io.github.orionlibs.orion.core.string.StringsService;
import io.github.orionlibs.orion.core.web.service.google_maps.GoogleMapsService;
import io.github.orionlibs.orion.core.web.service.google_maps.OptimisedRouteBO;
import io.github.orionlibs.orion.core.web.service.google_maps.model.DistanceAndTravelDurationModel;
...
{
    public static OptimumRouteVO getOptimumRouteForPostcodes(String startPostcodeToUse, String endPostcode, List<String> waypoints)
    {
    ...
    private static OptimumRouteVO createRouteForMoreThan25Waypoints(String startPostcode, String endPostcode, List<String> waypoints)
    {
        List<String> route = new LinkedList<>();
        List<String> invalidPostcodes = new ArrayList<>();
        List<RecipientPostcodeVO> recipientPostcodes = new ArrayList<>();
        ...
        else
        {
            ...
            List<RecipientPostcodeGroupByPrefixVO> groups = new ArrayList<>();
            ...
            for(Map.Entry<String, List<RecipientPostcodeVO>> entry : postcodePrefixToRecipientMapper.entrySet())
            {
                ...
                groups.add(RecipientPostcodeGroupByPrefixVO.builder()
            ...
            else
            {
                ...
                for(RecipientPostcodeGroupByPrefixVO group : groups)
                {
