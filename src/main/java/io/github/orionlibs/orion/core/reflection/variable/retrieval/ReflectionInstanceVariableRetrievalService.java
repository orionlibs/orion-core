...
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.GetDeclaredInstanceVariableTask;
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.GetDeclaredProtectedInstanceVariableTask;
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.GetDeclaredPublicInstanceVariableTask;
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.GetInherittedInstanceVariableTask;
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.GetPrivateInstanceVariableTask;
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.IsPrivateVariableTask;
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.IsProtectedVariableTask;
import io.github.orionlibs.orion.core.reflection.variable.retrieval.tasks.IsPublicVariableTask;
