package io.github.orionlibs.orion.core.data.structure.set.type;
...
import io.github.orionlibs.orion.core.data.structure.set.OrionSetService;
...
public class OrionHashMultiSet<T> extends Orion implements OrionSet<T>, UnorderedDataStructure, UnindexedDataStructure
{
