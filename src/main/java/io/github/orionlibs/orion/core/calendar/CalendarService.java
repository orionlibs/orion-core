...
import io.github.orionlibs.orion.core.calendar.calculation.tasks.AddDaysToDatetimeTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.AddWorkingDaysToDatetimeTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.AddYearsToDatetimeTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.GetAllWeeksOfTheLastNWeeksAsPairsOfStartAndEndDateTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.GetAllWeeksOfTheLastNWeeksAsPairsOfStartAndEndDateWithFirstDayOfWeekBeingMondayTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.GetAllWeeksOfTheLastNWeeksAsPairsOfStartAndEndDateWithFirstDayOfWeekBeingSundayTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.GetDaylightSavingsHoursToAddTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.GetNumberOfMonthDaysTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.difference.GetDifferenceAsListBetweenTwoDateTimesBasedOnChronoUnitsTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.difference.GetDifferenceBetweenTwoDateTimesInDaysTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.difference.GetDifferenceBetweenTwoDateTimesInMillisecondsTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.difference.GetDifferenceBetweenTwoDatesInDaysTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.difference.GetDifferenceBetweenTwoDatesInMillisecondsTask;
import io.github.orionlibs.orion.core.calendar.calculation.tasks.difference.GetDifferenceBetweenTwoTimesInMillisecondsTask;
import io.github.orionlibs.orion.core.calendar.conversion.OrionDuration;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.ConvertDateToLongFormatTask;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.ConvertDateToLongFormatWithoutYearTask;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.ConvertDateToLongFormatYearFirstTask;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.ConvertMillisecondsToTemporalUnitTask;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.sqldate.ConvertSQLDateToDateObjectTask;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.sqldate.ConvertSQLDateToDateTimeObjectTask;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.sqldate.ConvertSQLTimestampToDateTimeObjectAndAdjustForDaylightSavingsTask;
import io.github.orionlibs.orion.core.calendar.conversion.tasks.sqldate.ConvertSQLTimestampToDateTimeObjectTask;
...
import io.github.orionlibs.orion.core.calendar.tasks.GetDateFormatterToUseTask;
import io.github.orionlibs.orion.core.calendar.tasks.GetDateTimeFormatterToUseTask;
import io.github.orionlibs.orion.core.calendar.tasks.GetTimeFormatterToUseTask;
import io.github.orionlibs.orion.core.calendar.tasks.GetTimeZoneOffsetInHoursFromUTCTask;
import io.github.orionlibs.orion.core.calendar.tasks.GetTimeZoneOffsetInMinutesFromUTCTask;
import io.github.orionlibs.orion.core.calendar.tasks.GetTimeZoneOffsetStringFromUTCTask;
import io.github.orionlibs.orion.core.calendar.tasks.IsDateWithinRangeTask;
import io.github.orionlibs.orion.core.calendar.tasks.IsTimeWithinRangeIgnoringSecondsAndMillisecondsTask;
import io.github.orionlibs.orion.core.calendar.tasks.IsTimeWithinRangeTask;
import io.github.orionlibs.orion.core.calendar.tasks.SortDateTimesTask;
import io.github.orionlibs.orion.core.calendar.tasks.SortDatesTask;
import io.github.orionlibs.orion.core.calendar.tasks.TokeniseDateStringTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.FormatDateTimeUnitWith2CharactersTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.FormatDifferenceBetweenTwoDateTimesBasedOnUnitsTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.FormatDurationTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.FormatZonedDateAndTimeOrDateAndTimeOrDateOrTimeTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.FormatZonedDateTimeOrDateTimeOrDateOrTimeTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.GetDurationInSecondsRoundedUpToTheClosestNMinuteMarkTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.GetFormattedDateTimeTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.GetFormattedDurationInHoursAndMinutesTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.PrintDateAsTodayOrTomorrowOrFullDateTask;
import io.github.orionlibs.orion.core.calendar.tasks.format.PrintDateAsTodayOrTomorrowOrFullDateTimeTask;
...
public class CalendarService extends OrionService
{
    ...
    public static String formatDateTimeUnitWith2Characters(long unit)
    {
        return FormatDateTimeUnitWith2CharactersTask.run(unit);
    }
    ...
    public static boolean isDateEqualsAnother(DateTime dateTime1, DateTime dateTime2)
    {
    ...
    public static boolean isDateAfterAnother(DateTime dateTime1, DateTime dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertDatetimeToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertDatetimeToZonedDatetime(dateTime2);
    ...
    public static boolean isDateAfterAnother(Timestamp dateTime1, Timestamp dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertTimestampToZonedDatetime(dateTime1);
    ...
    public static boolean isDateBeforeAnother(DateTime dateTime1, Timestamp dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertDatetimeToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertTimestampToZonedDatetime(dateTime2);
    ...
    public static boolean isDateBeforeAnother(Timestamp dateTime1, Timestamp dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertTimestampToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertTimestampToZonedDatetime(dateTime2);
        return zonedDatetime1.isBefore(zonedDatetime2);
    ...
    public static boolean isDateAfterOrEqualsAnother(DateTime dateTime1, DateTime dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertDatetimeToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertDatetimeToZonedDatetime(dateTime2);
    ...
    public static boolean isDateBeforeAnother(DateTime dateTime1, DateTime dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertDatetimeToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertDatetimeToZonedDatetime(dateTime2);
        return zonedDatetime1.isBefore(zonedDatetime2);
    ...
    public static boolean isDateBeforeAnotherOrEquals(DateTime dateTime1, DateTime dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertDatetimeToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertDatetimeToZonedDatetime(dateTime2);
    ...
    public static boolean isDateBeforeAnotherOrEquals(Date date1, Date date2)
    {
    ...
    public static boolean isDateBeforeAnother(Date date1, Date date2)
    {
        ZonedDateTime zonedDatetime1 = convertDateObjectToDateTimeObject(date1).toZonedDateTime();
        ZonedDateTime zonedDatetime2 = convertDateObjectToDateTimeObject(date2).toZonedDateTime();
        return zonedDatetime1.isBefore(zonedDatetime2);
    ...
    {
        return isDateBeforeAnother(dateTime, getCurrentDatetime());
    }
    ...
    public static boolean isDateBeforeOrEqualsAnother(DateTime dateTime1, DateTime dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertDatetimeToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertDatetimeToZonedDatetime(dateTime2);
        return zonedDatetime1.isBefore(zonedDatetime2) || zonedDatetime1.isEqual(zonedDatetime2);
    ...
    public static boolean isDateBeforeOrEqualsAnother(Timestamp dateTime1, Timestamp dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertTimestampToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertTimestampToZonedDatetime(dateTime2);
        return zonedDatetime1.isBefore(zonedDatetime2) || zonedDatetime1.isEqual(zonedDatetime2);
    ...
    public static boolean isDateBeforeOrEqualsAnother(Timestamp dateTime1, DateTime dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertTimestampToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertDatetimeToZonedDatetime(dateTime2);
        return zonedDatetime1.isBefore(zonedDatetime2) || zonedDatetime1.isEqual(zonedDatetime2);
    ...
    public static boolean isDateBeforeOrEqualsAnother(DateTime dateTime1, Timestamp dateTime2)
    {
        ZonedDateTime zonedDatetime1 = convertDatetimeToZonedDatetime(dateTime1);
        ZonedDateTime zonedDatetime2 = convertTimestampToZonedDatetime(dateTime2);
        return zonedDatetime1.isBefore(zonedDatetime2) || zonedDatetime1.isEqual(zonedDatetime2);
    ...
    public static List<WeekPeriod> getAllWeekPeriodsOfTheLastNWeeksAsPairsOfStartAndEndDateWithFirstDayOfWeekBeingMonday(int numberOfWeeksToReturn)
    {
