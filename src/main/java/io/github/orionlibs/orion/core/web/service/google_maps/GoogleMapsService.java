...
import io.github.orionlibs.orion.core.web.service.google_maps.route.OptimumRouteService;
import io.github.orionlibs.orion.core.web.service.google_maps.route.OptimumRouteVO;
...
public class GoogleMapsService extends OrionService
{
    ...
    public static OptimumRouteVO getOptimumRouteForPostcodes(String startPostcode, String endPostcode, List<String> waypoints)
    {
