package io.github.orionlibs.orion.core.exception.tasks;
...
public class GetAllErrorMessagesFromTheHierarchyTask extends Orion
{
    public static String run(Throwable exception)
    {
