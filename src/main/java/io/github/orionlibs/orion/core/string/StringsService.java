...
import io.github.orionlibs.orion.core.string.tasks.ArePermutationsOfEachOtherTask;
import io.github.orionlibs.orion.core.string.tasks.ConcatenateSeparatedBySpaceTask;
import io.github.orionlibs.orion.core.string.tasks.ConcatenateTask;
import io.github.orionlibs.orion.core.string.tasks.ConnectStringsByStringTask;
import io.github.orionlibs.orion.core.string.tasks.ConvertFirstCharacterOfEachWordToUppercaseTask;
import io.github.orionlibs.orion.core.string.tasks.ConvertFirstCharacterToUppercaseTask;
import io.github.orionlibs.orion.core.string.tasks.ConvertToCommaAndSpaceSeparatedStringTask;
import io.github.orionlibs.orion.core.string.tasks.ConvertToCommaSeparatedStringTask;
import io.github.orionlibs.orion.core.string.tasks.CopyFromTheBeginningUpToTask;
import io.github.orionlibs.orion.core.string.tasks.CopyStringTask;
import io.github.orionlibs.orion.core.string.tasks.DeleteCharacterFromTheEndTask;
import io.github.orionlibs.orion.core.string.tasks.DeleteLineSeparatorFromTheEndTask;
import io.github.orionlibs.orion.core.string.tasks.DoesMatchRegularExpressionTask;
import io.github.orionlibs.orion.core.string.tasks.DoesStringEndWithAnyTask;
import io.github.orionlibs.orion.core.string.tasks.DoesStringStartWithAnyTask;
import io.github.orionlibs.orion.core.string.tasks.GenerateRandomNumericCodeTask;
import io.github.orionlibs.orion.core.string.tasks.GenerateRandomStringTask;
import io.github.orionlibs.orion.core.string.tasks.GetAlphabeticalValueTask;
import io.github.orionlibs.orion.core.string.tasks.GetHashCodeTask;
import io.github.orionlibs.orion.core.string.tasks.GetLongestCommonSubstringTask;
import io.github.orionlibs.orion.core.string.tasks.GetSimilarityPercentageBetweenTask;
import io.github.orionlibs.orion.core.string.tasks.IsLastCharacterAWhitespaceTask;
import io.github.orionlibs.orion.core.string.tasks.IsOnlyAlphabeticalTask;
import io.github.orionlibs.orion.core.string.tasks.IsOnlyAlphabeticalWithHyphensAndSpacesTask;
import io.github.orionlibs.orion.core.string.tasks.IsOnlyAlphabeticalWithHyphensTask;
import io.github.orionlibs.orion.core.string.tasks.PermuteStringTask;
import io.github.orionlibs.orion.core.string.tasks.PrefixStringTask;
import io.github.orionlibs.orion.core.string.tasks.SeparateByStringTask;
import io.github.orionlibs.orion.core.string.tasks.ShuffleStringTask;
import io.github.orionlibs.orion.core.string.tasks.SurroundWithStringTask;
import java.util.ArrayList;
import java.util.Collection;
import java.util.List;
import java.util.stream.IntStream;

public class StringsService extends OrionService
{
