package io.github.orionlibs.orion.core.reflection.enumeration;

import io.github.orionlibs.orion.core.abstraction.OrionService;
import io.github.orionlibs.orion.core.reflection.enumeration.tasks.GetEnumerationDefinitionsTask;
import io.github.orionlibs.orion.core.reflection.enumeration.tasks.GetEnumerationNameTask;
import io.github.orionlibs.orion.core.reflection.enumeration.tasks.GetEnumerationValueTask;
import io.github.orionlibs.orion.core.reflection.enumeration.tasks.InstantiateEnumerationTask;
