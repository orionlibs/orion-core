package io.github.orionlibs.orion.core.cryptology.encryption.rsa.tasks;
...
public class GenerateRSAKeyTask extends Orion
{
    ...
    private static void saveKeys(String fileName, BigInteger modulus, BigInteger exponent) throws IOException
    {
        ...
        {
            OrionUtils.closeResource(objectWriter);
            OrionUtils.closeResource(fileWriter);
        }
