package io.github.orionlibs.core.file_system.file;

import io.github.orionlibs.core.abstraction.OrionService;
import io.github.orionlibs.core.exception.Assert;
import io.github.orionlibs.core.file_system.FileSystemService;
import io.github.orionlibs.core.file_system.file.tasks.AppendToFileTask;
import io.github.orionlibs.core.file_system.file.tasks.ConvertFileToStringListTask;
import io.github.orionlibs.core.file_system.file.tasks.ConvertFileToStringTask;
import io.github.orionlibs.core.file_system.file.tasks.ConvertURLToFileTask;
import io.github.orionlibs.core.file_system.file.tasks.CreateFileTask;
import io.github.orionlibs.core.file_system.file.tasks.DeleteFileTask;
import io.github.orionlibs.core.file_system.file.tasks.DownloadFileTask;
import io.github.orionlibs.core.file_system.file.tasks.GetFileExtensionTask;
import io.github.orionlibs.core.file_system.file.tasks.MoveFileTask;
import io.github.orionlibs.core.file_system.file.tasks.ReadFirstLineFromFileTask;
import io.github.orionlibs.core.file_system.file.tasks.SaveFileTask;
import io.github.orionlibs.core.file_system.file.tasks.SaveStringToFileTask;
import io.github.orionlibs.core.file_system.file.tasks.SaveTemporaryFileToServerTask;
import io.github.orionlibs.core.file_system.file.tasks.UploadFileTask;
