package io.github.orionlibs.core.file_system;

import io.github.orionlibs.core.abstraction.OrionService;
import io.github.orionlibs.core.file_system.tasks.DeleteFileOrDirTask;
import io.github.orionlibs.core.file_system.tasks.PrintFileSystemTask;
import io.github.orionlibs.core.file_system.tasks.PrintFilesAndDirectoriesTask;
import io.github.orionlibs.core.file_system.tasks.RenameFileOrDirectoryTask;
import java.io.BufferedWriter;
import java.io.File;
import java.io.IOException;

public class FileSystemService extends OrionService
{
