...
import io.github.orionlibs.core.data.structure.list.tasks.AreListsTheSameTask;
import io.github.orionlibs.core.data.structure.list.tasks.ConcatenateListsTask;
import io.github.orionlibs.core.data.structure.list.tasks.DoListsSizesMatchTask;
import io.github.orionlibs.core.data.structure.list.tasks.DoesElementExistInAllListsTask;
import io.github.orionlibs.core.data.structure.list.tasks.GetIntersectionTask;
import io.github.orionlibs.core.data.structure.list.tasks.GetListAsArrayTask;
import io.github.orionlibs.core.data.structure.list.tasks.SubListTask;
import io.github.orionlibs.core.data.structure.list.tasks.SwapIndicesTask;
import io.github.orionlibs.core.data.structure.list.type.OrionArrayList;
import java.util.List;

public class ListService<T> extends OrionService
{
