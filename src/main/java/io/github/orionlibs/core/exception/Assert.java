...
public class Assert extends Orion
{
    public static void notNull(Object object, String errorMessage)
    {
        org.springframework.util.Assert.notNull(object, errorMessage);
    }
    ...
    {
        notNull(object, errorMessage);
        org.springframework.util.Assert.hasLength(object, errorMessage);
    }
    ...
    {
        notNull(object, errorMessage);
        org.springframework.util.Assert.notEmpty(object, errorMessage);
    }
    ...
    public static void onlyAlphabetic(String s, String errorMessage)
    {

        if(StringsService.isNotOnlyAlphabetical(s))
        {
            throw new InvalidArgumentException(errorMessage);
        }
