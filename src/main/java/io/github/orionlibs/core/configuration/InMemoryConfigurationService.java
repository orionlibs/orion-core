...
import io.github.orionlibs.core.configuration.tasks.RegisterClassStaticVariablesToRegistryTask;
import io.github.orionlibs.core.exception.Assert;
import io.github.orionlibs.core.exception.ResourceException;
...
public class InMemoryConfigurationService
{
    ...
    public static void registerClassStaticVariables(Class<?> aClass)
    {
        RegisterClassStaticVariablesToRegistryTask.run(aClass);
    }
