...
public class FormatDurationTask extends Orion
{
    public static FormattedDateTime run(OrionDuration duration)
    {
        ...
        formattedDateTime.setFormattedNumberOfYears(formattedNumberOfYears);
        formattedDateTime.setFormattedNumberOfMonths(formattedNumberOfMonths);
        formattedDateTime.setFormattedNumberOfDays(formattedNumberOfDays);
        formattedDateTime.setFormattedNumberOfHours(formattedNumberOfHours);
        formattedDateTime.setFormattedNumberOfMinutes(formattedNumberOfMinutes);
        formattedDateTime.setFormattedNumberOfSeconds(formattedNumberOfSeconds);
        formattedDateTime.setFormattedDurationIn1Sentence(formattedDurationIn1Sentence);
